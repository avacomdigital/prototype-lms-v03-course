...
urlpatterns = [
    ...
    path("contenido/reconciliar/", ContenidoReconciliarView.as_view(), name="contenido-reconciliar"),
    ...
    path("courses/<str:course_id>/contenido/", CursoContenidoView.as_view(), name="curso-contenido"),
